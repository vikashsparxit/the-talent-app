-- Atomic function to advance a candidate from one interview stage to the next.
-- Both the update and insert run in a single transaction — if either fails, both roll back.
