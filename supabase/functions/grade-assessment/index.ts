...
function extractExecutionScore(_response: Json, _maxMarks: number): number | null {
  // Client-stored execution_result is not trusted; coding questions are AI-graded.
  return null;
}
