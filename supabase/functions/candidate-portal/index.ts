...
function stripClientScoreFields(response: unknown): unknown {
  ...
  try {
    ...
    switch (action) {
      ...
      case 'save-response': {
        ...
        const { question_id, response, time_spent } = data || {};
        ...
        // Client-supplied scores are ignored; MCQ scoring is a DB trigger, others via grade-assessment.
        let sanitizedResponse = stripClientScoreFields(response);
