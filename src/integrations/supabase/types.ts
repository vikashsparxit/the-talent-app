...
export type Database = {
  ...
  public: {
    Tables: {
      applicant_profiles: {
        Row: {
          ...
          sensitive_data_consent_source: string | null
          skills: Json | null
          updated_at: string
          user_id: string
    ...
    Functions: {
      ...
      insert_audit_log: {
        Args: {
          ...
          _entity_type: string
          _entity_id: string
          _before_data?: Json | null
          _after_data?: Json | null
          _ip?: string | null
        }
        Returns: string
      }
      ...
      lookup_applicant_avatars: {
        Args: { p_emails: string[] }
        Returns: { email: string; avatar_url: string }[]
      }
    ...
    Enums: {
      ...
      job_status: "draft" | "open" | "paused" | "closed" | "cancelled"
      job_type:
        | "full_time"
        | "part_time"
        | "contract"
