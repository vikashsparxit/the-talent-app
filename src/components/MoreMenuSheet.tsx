...
import { getMoreMenuItems, isNavLinkActive, type NavLinkItem } from '@/lib/navConfig';
      ...
      <DrawerContent className="max-h-[85vh]">
        ...
        <nav className="overflow-y-auto px-2 pb-safe">
          <ul className="space-y-1 py-2">
            {items.map(item => {
              const active = !item.action && isNavLinkActive(location.pathname, location.search, item.href);
