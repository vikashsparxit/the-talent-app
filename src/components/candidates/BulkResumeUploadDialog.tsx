  ...
  const processFiles = async () => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        ...
        const candidateName = mapped.full_name || rf.file.name.replace(/\.[^/.]+$/, '');
        const candidateEmail = mapped.email || null;
        ...
        const { data: inserted, error: insertError } = await supabase
          ...
          .insert({
            ...
            role_applied: mapped.current_role || null,
            skills: mapped.skills as unknown as Json,
            resume_url: storageName,
            parse_score: mapped.parse_score || 0,
            experience_years: mapped.experience_years || null,
            candidate_current_role: mapped.current_role || null,
            candidate_current_company: mapped.current_company || null,
            work_experience: (mapped.work_experience as unknown as Json) || null,
            education: (mapped.education as unknown as Json) || null,
            certifications: (mapped.certifications as unknown as Json) || null,
            awards: (mapped.awards as unknown as Json) || null,
            credential_score: mapped.credential_score || null,
            source: 'bulk_resume',
