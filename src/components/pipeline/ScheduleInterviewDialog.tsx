...
import { CalendarDays, Video, MapPin, Phone, Loader2, Link } from 'lucide-react';
...
export function ScheduleInterviewDialog({
  ...
  const handleSubmit = () => {
    ...
    onSubmit({
      ...
      meeting_link: selectedMode === 'video' && meetingLink.trim() ? meetingLink.trim() : undefined,
    });
  };
  ...
  const canSubmit = selectedPanelists.length >= 1;
