    ...
    >
      <div className={cn(
        ...
        <span className="text-center leading-snug">
          {current.message}
          {current.link_label && current.link_url && safeHref(current.link_url) && (
            <>
              {' '}
              <a
                href={safeHref(current.link_url)!}
                target={safeHref(current.link_url)!.startsWith('http') ? '_blank' : undefined}
