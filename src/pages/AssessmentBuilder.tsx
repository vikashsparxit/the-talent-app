...
import type { AssessmentStatus, QuestionType } from '@/types/database';
...
export default function AssessmentBuilder() {
  ...
  const [newSection, setNewSection] = useState({ title: '', description: '', weightage: 100, skill_tags: '' });
  ...
  const handleAddSection = async () => {
    if (!id || !newSection.title.trim()) return;
    const skillTagsArr = newSection.skill_tags.split(',').map(s => s.trim()).filter(Boolean);
    ...
    setNewSection({ title: '', description: '', weightage: 100, skill_tags: '' });
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <Button onClick={() => setIsSectionDialogOpen(true)} variant="outline" className="gap-2">
        ...
        {assessment.sections.length === 0 ? (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <Button onClick={() => setIsSectionDialogOpen(true)} className="gap-2">
                <Plus className="h-4 w-4" />
                Add Section
              </Button>
            </CardContent>
                  ...
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-muted-foreground">
                        ...
                        {(section as any).skill_tags && Array.isArray((section as any).skill_tags) && (section as any).skill_tags.length > 0 && (
                          <span className="ml-2">• Skills: {(section as any).skill_tags.join(', ')}</span>
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="weightage"
                  type="number"
                  value={newSection.weightage}
                  onChange={(e) => setNewSection(prev => ({ ...prev, weightage: parseInt(e.target.value) || 100 }))}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={newSection.skill_tags}
                  onChange={(e) => setNewSection(prev => ({ ...prev, skill_tags: e.target.value }))}
                />
