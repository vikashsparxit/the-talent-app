...
export default function Jobs() {
  ...
  const completedJobs = useMemo(() => jobs.filter((j) => isCompletedJobStatus(j.status)), [jobs]);
      ...
      <Select value={filterStatus} onValueChange={setFilterStatus}>
        ...
        <SelectContent>
          ...
          {Object.entries(jobStatusLabels)
            .filter(([val]) =>
              jobListTab === 'active'
                ? isActiveJobStatus(val as JobStatus)
                : isCompletedJobStatus(val as JobStatus),
            )
            .map(([val, label]) => (
            ...
            <CardContent>
              ...
              <p className="text-muted-foreground mb-4">
                {jobListTab === 'completed'
                  ? 'Closed and cancelled jobs appear here. Cancelled means the opening was dropped with no hire.'
