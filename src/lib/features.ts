...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: 'Every candidate assigned to a job lands in a Pending Approval column before entering any interview stage. Recruiters review the profile, approve (moves to Screening) or decline with a required reason. Declined candidates stay visible at the bottom for sourcing visibility.',
    roles: ['HR', 'Recruiter'],
    addedAt: '2026-05-26',
  },
  {
    ...
    description: 'When declining a candidate from Pending Approval, a free-text reason is required (e.g. "Skills don\'t match the role requirements"). The reason is stored and shown on the declined card — helps sourcing teams calibrate future submissions.',
    roles: ['HR', 'Recruiter'],
    addedAt: '2026-05-28',
  },
  {
