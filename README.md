...
| **Interview Pipeline** | Kanban at `/hiring` with drag-and-drop, pinned job tabs, smart stage sorting (active on top), stage templates, interview scheduling, structured feedback, work sample uploads, and explicit **Mark as Hired** (`hired_at`) |
...
| **Reports** | Pipeline funnel, recruiter leaderboard, sourcing trends, time-to-hire metrics, AI pipeline health scorer |
