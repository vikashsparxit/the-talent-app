...
The Talent App is an open-source ATS that goes beyond tracking — it actively supports the hiring process. Recruiters manage candidates and pipelines; an optional AI agent named **Chitragupta** watches activity, enforces deadlines, escalates issues, and celebrates wins.
